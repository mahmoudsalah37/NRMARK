<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CLeanCat.aspx.cs" Inherits="NRMARKv1.Models.CleanCat" %>
...
<%--            <div class="container">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <h3 class="section-subheading text-muted">جميع فئات أدوات النظافة</h3>
                    </div>
                </div>
        ...
        <script>
            function cleanItem(clicked_id) {
                window.location.href = "../Models/CleanItems.aspx?clicked_id="+clicked_id ;
            }
